...
<script type="text/javascript" src="/public/js/arial.js"></script>
<script type="text/javascript" src="/public/js/cuf_run.js"></script>
<!-- CuFon ends -->
</head>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
        ...
        <form id="form" name="form" method="post" action="">
          ...
          <input name="b" type="image" src="/public/images/search.gif" class="button" />
      ...
      <img src="/public/images/img_main.jpg" alt="image" width="970" height="202" /></div>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <img src="/public/images/img_1.jpg" width="613" height="179" alt="image" />
          <div class="clr"></div>
...
which means that you are free to use it for any personal or commercial purpose provided you credit me in the form of a link back to <a href="http://www.cssmoban.com/" title="模板之家">模板之家</a>.</p>
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <p>Posted on 18. Sep, 2015 by Sara in Filed under templates, internet,  with  Comments 18</p>
          <img src="/public/images/img_2.jpg" width="613" height="179" alt="image" />
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2>Wise Words</h2>
          <div class="clr"></div>
          <p>   <img src="/public/images/teast_img_1.gif" alt="image" width="18" height="20" /> <em>We can let circumstances rule us, or we can take charge and rule our lives from within </em>.<img src="/public/images/teast_img_2.gif" alt="image" width="18" height="20" /></p>
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="col c1">
        ...
        <a href="#"><img src="/public/images/gallery_1.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="/public/images/gallery_2.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="/public/images/gallery_3.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="/public/images/gallery_4.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="/public/images/gallery_5.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="/public/images/gallery_6.jpg" width="58" height="58" alt="pix" /></a> </div>
      <div class="col c2">
    ...
    <div class="footer">
      ...
      <p class="lf">Collect from: <a href="http://www.cssmoban.com/" title="网站模板" target="_blank">网站模板</a></p>
      <div class="clr"></div>
    </div>
  </div>
</div>
